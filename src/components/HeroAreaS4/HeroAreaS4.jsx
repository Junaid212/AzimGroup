...
import SliderBg1 from '../../img/hero/hero_bg_4_1.jpg';
import author from '../../img/icon/author.png';
import bar from '../../img/icon/bar-code.svg';
...
const slides = [
   {
      id: '01',
      title: 'Welcome to Rotal Full of Luxury Experience',
   ...
   {
      id: '03',
      title: 'Discover The Perfect Blend of Luxury Resort',
      dicpt: 'Rotal hotel is a peaceful place to rest, to recover your energies and to have great laughs with your family.',
      SliderBg: SliderBg3,
   },
...
const HeroAreaS4 = () => {
   ...
   return (
      <div className="th-hero-wrapper hero-3 hero-4 slider-area" id="hero">
         <div className="slider-area">
            <Swiper
               ...
               className="swiper th-slider" id="heroSlide4"
            >
               {slides.map((bg, index) => (
                  <SwiperSlide
                     key={index}
